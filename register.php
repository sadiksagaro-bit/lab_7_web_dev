    ...
    if ($matric === "" || $name === "" || $password === "" || $role === "") {
        ...
        if (!$stmt) {
            ...
            try {
                ...
                if ($e->getCode() == 1062) {
                    $error = "This matric number already exists.";
                } else {
...
<head>
    <meta charset="UTF-8">
    <title>Create Account | Student Manager</title>
    <style>
...
<div class="card">
    ...
    <div class="logo-wrap">
        <div class="logo-circle">
            <img src="https://cdn-icons-png.flaticon.com/512/992/992651.png" alt="Register Logo">
        </div>
    </div>
